...
import cLogo from '../assets/images/skills/firebaseLogo.png';
        ...
        <section id='skills'>
            ...
            <div className="container">
                ...
                <div className="col s12 l6 skills">
                    ...
                    <img className='col s3 nodephpLogo' src={databaseLogo} alt="Node PHP"/>
                ...
                <div className="col s6 push-l6 skillsText">Experience with <strong>Firebase, MongoDB, MySQL </strong>building apps that interact with <strong>databases.</strong></div>  
                    <img className='col s3 pull-l6 androidLogo' src={cLogo} alt='Android'/>
                    <img className='col s3 pull-l6 cLogo'  src={databaseLogo} alt="C"/>
                </div>
